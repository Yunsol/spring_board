...
{
	private CriPage cri;// page, perPageNum 을 가지고 있음
	...
	public void setCri(CriPage cri)
	{
		this.cri = cri;
	}
	...
	public String makeQuery(int page)
	{
		...
		UriComponents uriComponents = UriComponentsBuilder
			.newInstance().queryParam("page", page).queryParam("perPageNum", cri.getPerPageNum()).build();
