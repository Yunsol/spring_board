...
<body>
	...
	BOARD READ PAGE
		...
		<div id="buttonDiv">
			<a href="${pageContext.request.contextPath}/board/checkPswd?id=${board.id}&nextPage=update">수정</a>
			<a href="${pageContext.request.contextPath}/board/checkPswd?id=${board.id}&nextPage=delete">삭제</a>
